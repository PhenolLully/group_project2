...
const movies = {
  ...
  thriller: ["Movie A", "Movie B", "Movie C"],
  horror: ["Movie X", "Movie Y", "Movie Z"],
  comedy: ["Funny Movie 1", "Laugh Movie 2", "Hilarious Movie 3"],
  romance: ["Romantic Movie A", "Love Story B", "Sweetheart Movie C"]
};
